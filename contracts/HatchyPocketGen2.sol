...
contract HatchyPocketGen2 is Random, OwnableUpgradeable, ERC1155Upgradeable {
    ...
    uint public constant MAX_SHINY = 140;
    // uint public constant MAX_COMMON = 1;
    uint public constant MAX_COMMON = 5000;
    ...
    function initialize1() external onlyOwner {
        ...
        uint8[30] memory _solarCommonPool = [45, 46, 55, 56, 61, 68, 74, 75, 78, 82, 84, 88, 98, 102, 105, 107, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136];
    ...
    function initialize2() external onlyOwner {
        ...
        uint24[32] memory _solarShinyPool = [11111111, 141888, 45888, 46888, 55888, 56888, 61888, 68888, 74888, 75888, 78888, 82888, 84888, 88888, 98888, 102888, 105888, 107888, 123888, 124888, 125888, 126888, 127888, 128888, 129888, 130888, 131888, 132888, 133888, 134888, 135888, 136888];
    ...
    function initialize3() external onlyOwner {
        ...
        uint8[30] memory _lunarCommonPool = [40, 41, 42, 49, 54, 62, 71, 72, 73, 77, 85, 86, 94, 95, 100, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122];
    ...
    function initialize4() external onlyOwner {
        ...
        uint24[32] memory _lunarShinyPool = [10100101, 140888, 40888, 41888, 42888, 49888, 54888, 62888, 71888, 72888, 73888, 77888, 85888, 86888, 94888, 95888, 100888, 108888, 109888, 110888, 111888, 112888, 113888, 114888, 115888, 116888, 117888, 118888, 119888, 120888, 121888, 122888];
